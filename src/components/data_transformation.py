...
class DataTransformation:
    ...
    def get_data_transformation_object(self):
        try:
            ...
            categorical_cols = ['Weather_conditions', 'Road_traffic_density', 'Type_of_order', 'Type_of_vehicle', 'Festival', 'City', 'Week_days']
            numerical_cols = ['Delivery_person_Age', 'Delivery_person_Ratings', 'Vehicle_condition','multiple_deliveries', 'Time_Orderd_Hours', 'Time_Orderd_Minutes','Time_Order_picked_Hours', 'Time_Order_picked_Minutes','Distance_Resturant_to_Location']
